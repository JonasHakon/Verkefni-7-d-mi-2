...
// Hnútar veggsins 1
var vertices = [
    vec4( -100.0,  0.0, 1.0, 1.0 ),
    vec4(  100.0,  0.0, 1.0, 1.0 ),
    vec4(  100.0,  10.0, 1.0, 1.0 ),
    vec4(  100.0,  10.0, 1.0, 1.0 ),
    vec4( -100.0,  10.0, 1.0, 1.0 ),
    vec4( -100.0,  0.0, 1.0, 1.0 ),
// Hnútar veggs 2
         ...
         switch( e.keyCode ) {
            case 87:	// w
                if (userZPos < 1.3) {
                    ...
                    userZPos += Math.abs(userIncr * userZDir);;
                } else if (userZPos > 2.7) {
                    userXPos += userIncr * userXDir;
                    userZPos += -Math.abs(userIncr * userZDir);;
                } else {
                    userXPos += userIncr * userXDir;
            ...
            case 65:	// a
            if (userZPos < 1.3) {
                userZPos -= -Math.abs(userIncr * userXDir);
